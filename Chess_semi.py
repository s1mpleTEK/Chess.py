...
from pieces_move_semi.paw import paw_move, paw_evolution
from pieces_move_semi.knight import knight_move
from pieces_move_semi.bishop import bishop_move
from pieces_move_semi.rook import rook_move
from pieces_move_semi.queen import queen_move
from pieces_move_semi.king import king_move
from pieces_move_semi.special_move import castling_move

from chess_conditions_semi.check_condition import check
...
def set_table():                                    #init game board
    ...
    for i in range (2):                             #i=0 > i=1
        table[8] = entity[2][1]                         #set ¤ in every corner and browse y of table (first line and last line)
