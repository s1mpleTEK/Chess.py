...
def castling_move(table, user, path_pieces, entity, rooks_move):     #verification for validate castling
    if user[2] == 1:
        if path_pieces[1][1] == 7:                                                #verify the line of the destination
            if path_pieces[1][2] == 1 and rooks_move[1][0] == 0:                  #check the left rook and verify if it has already moved
                for i in range (2, 5):                                  #browse distance between king and rook at queenside
                    if table[7][i] != entity[2][0]:                      #verify if the space between them it is empty
        ...
        if path_pieces[1][1] == 0:                                                #verify the line of the destination
            if path_pieces[1][2] == 1 and rooks_move[0][0] == 0:                  #check the left rook and verify if it has already moved
                for i in range (2, 5):                                  #browse distance between king and rook at queenside
                    if table[0][i] != entity[2][0]:                      #verify if the space between them it is empty
                        return (False)                                  #not empty
                    return (True)                                       #empty
